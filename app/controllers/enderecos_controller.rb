class EnderecosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @endereco.save
        format.html { redirect_to @endereco, notice: 'Endereçoo criado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @endereco.update(endereco_params)
        format.html { redirect_to @endereco, notice: 'Endereco atualizado.' }
  ...
  def destroy
    @endereco.destroy
    respond_to do |format|
      format.html { redirect_to enderecos_url, notice: 'Endereco excluído.' }
  ...
  private
    ...
    def endereco_params
      params.require(:endereco).permit(:rua, :bairro, :cidade, :estado)
    end
end
